<html>
    ...
    <head>
        ...
        <script>
            ...
            if (location.href == "vantage.social"){
                console.log("Current page is vantage.social");
            }
    ...
    <body class="background">
        ...
        <center class="container" style="background-color: #EEE; position: fixed; background-size: cover; background-repeat: no-repeat; background-position: center center; height: 100%; width: 100%;">
            ...
            <!--<div style="text-decoration: underline;">Sign Up</div><br>-->
            <input class="textbox" type="text" placeholder="Email" id="email" style="width: 70%;"><br><br>
            <input class="textbox" type="password" placeholder="Password" id="password" style="width: 70%;"><br>
            <br><br>
            <button onclick="register_user();" type="submit" class="button" style="color: white;">Sign Up</button>
                <br><br>
                <a style="color: grey;" href="login.php" type="submit">Already have an account?</a><br><p id="message" style="color: #FF7043;"></p></div></div>
