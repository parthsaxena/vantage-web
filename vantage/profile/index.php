														...
														<div class="modal-header" align="center">
															...
															<center>
																<?php  
																	...
																	if ($username == $_SESSION['user']){
                                                                        ...
                                                                        if ($check > 0){
                                                                            ...
                                                                            <form action='' method='POST'>
                                                                            <button onclick='openChat();' type='submit' class='btn btn-warning'>
                                                                                Open Chat
                                                                            </button>
                                                                        </form>";
                                                                        }
                                                                           ...
                                                                           <div id='replace'>
                                                                        <form action='' method='POST'>
                                                                            <button type='submit' name='create_chat' class='btn btn-default'>
                                                                                <span class='glyphicon glyphicon-user'></span>&nbsp;&nbsp;Add to Contacts
                                                                            </button>
                                                                        </form>
                                                                        </div>
                                                                        "; 
                                                                ...
                                                                if(isset($_POST["create_chat"])){
                                                                    ...
                                                                    echo "<script>document.getElementById('replace').innerHTML = '<form action='' method='POST'>
                                                                            <button onclick='openChat();' type='submit' class='btn btn-warning'>
                                                                                Open Chat
                                                                            </button>
                                                                        </form>'</script>";
