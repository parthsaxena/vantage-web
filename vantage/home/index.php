...
?>
    ...
    <!--<script src="/vantage/js/typeahead.min.js"></script>-->
    <script>
  ...
  width: 100%;
    ...
    <script>
        function search() {
            ...
            var url = "/vantage/profile?u=" + username;
                ...
                <div class="col-lg-12">
                    <center>
                        <div class="top">
                            ...
                            <script>
                                /*if (hours <= 18) {
                                    document.write("<img id='headerLogo' style='position: relative; top: 15px;' src='../images/logo2.png' height='50'>");
                                }
                                else {
                                    document.write("<img id='headerLogo' style='position: relative; top: 15px;' src='../images/logo2.png' height='50'>");
                                }
                            ...
                            &nbsp;&nbsp;
                            <div style="">
                            <input style="font-size: 17px;" autocomplete="on" spellcheck="false" class="" name="typeahead" id="searchbar" type="text" placeholder="Search For A User..." required>
                            <button type="submit" style="height: 50px; position: relative; top: 14px; right: 20px;" class="btn btn-info" onclick="search()"><span class="glyphicon glyphicon-search"></span></button>
                        </div>
                            <br><br>
                        <div id="submit_post_div">
                            ...
                            <br><br>
                                <form action="submit_post.php" method="POST" enctype="multipart/form-data" required>
                                    ...
                                    <input style="border: none; font-size: 17px;" id="subject" autocomplete="off" spellcheck="false" name="class" id="searchbar" type="text" placeholder="Subject or Class (Optional)" required>
                                    <!--<br>
                                    <br>-->
                                ...
                                <script>
                                        function image() {
                                            ...
                                            "<input type='file' name='image' placeholder='Paste url for image'><br>";
                                        }
                                    </script>
                                </form>
                                <br>
                  ...
                  <?php
                                    ...
                                    while ($row = $query->fetch_array()) {
                                        ...
                                        echo "<center><div id='post_div'>
														<h4 style='margin-left: 20px;'><p style='color: #E53935; position: relative; right: 40%;'><img src='http://vantage.social/vantage/images/empty_profile_picture.jpg' height='50' width='50' class='img-circle' style='color: red;'> <i>Anonymous</i></p></h4> 
	...
	<a href='$image' target='_blank'><img src='$image' height='300'><br></a>
                                            ";
                                        }
       ...
       <div style='width: 50%; position: relative; color: transparent;'>
		<a onclick='window.history.back();'>Close Window</a>
		<div class='content' style='border: 2px; border-color: white; border-radius: 5px;'>
			<img src='$image' style='max-height: 500px;'>
                                ...
                                <div id='popup_$id' class='overlay'>
       <div style='width: 50%; background-color: white; position: relative; bottom: -100px;'>
		<a onclick='window.history.back();'>Close</a>
		<div class='content' style='border: 2px; border-color: white; border-radius: 5px;'>
