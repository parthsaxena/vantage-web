            ...
            <?php
                ...
                while($row = $get_messages_query->fetch_array()) {
                    ...
                    if ($posted_by == $user){
                        ...
                        echo "<span><div align='right' class=\"msgc\" style=\"\"><div class=\"msg msgfrom\">".$content."</div></div></span>";
                        }
                    }
                    else {
                      ...
                      <br><br>";
                         ...
                         echo "&nbsp;<span><img class='img-circle' src='$profile_picture' height='40'></span>";
                          if ($image != ""){
                      ...
                      <br><br>";*/
                       ...
                       echo "<span><div class=\"msgc\"> <div class=\"msg rec\">" .$content ."</div> </div><br></span>";
                    }
                      }
                    }
      ...
      <br><br><br><br><br><br>
        ...
        <script>
            ...
            socket.on('update messages', function() {
                ...
                window.scroll(0, Math.pow(10,10));
                
                 var u_message = document.getElementById("message_field").value;
                
                /*window.location.replace("index.php?id="+id+"&saved_message="+u_message+"#contact");
                
                var message = $('#message_field');
                var strLength= message.val().length;
                message.focus();
                message[0].setSelectionRange(strLength, strLength);*/
            });

        </script>
        <center>
            <br>
            <div id="contact" style="height: 105px;"></div>
        <div id="message_box">
        
          <input name="message" type="text" id="message_field" placeholder="Send A Message..." autofocus autocomplete="off" value="">
            
          <button style="visibility: hidden; background-color: #99CCFF; border: none; height: 1px; width: 1px; position: relative; right: 54px;" onclick="sendMessage()" id="submit_message">Send</button><br><br>
            </form>
            
            
            <script>
            document.getElementById('message_field').onkeydown = function(event) {
                if (event.keyCode == 13) {
                    sendMessage();
                }
            }
