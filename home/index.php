  ...
  width: 100%;
    ...
    <script>
        function search() {
            ...
            var url = "vantage.social/vantage/profile?u=" + username;
                ...
                <div class="col-lg-12">
                    <center>
                        <div class="top">
                            ...
                            &nbsp;&nbsp;
                            <input style="font-size: 17px;" autocomplete="on" spellcheck="false" class="" name="typeahead" id="searchbar" type="text" placeholder="Search For A User...">
